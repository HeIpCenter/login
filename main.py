...
async def notif(text):
    for a in admin:
        try: await bot.send_message(a, text)
        except: return False
...
async def handle_new_message(event):
    if event.is_private:
        ...
        else: await event.respond("Hubungi TG : @www_webdev untuk membeli source code Truelogin.")
